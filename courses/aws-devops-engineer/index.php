...
$PAGE->set_title("AWS Certified DevOps Engineer  | LearningBerg");
$PAGE->set_heading("AWS Certified DevOps Engineer"); 
...
echo '
        ...
        .secondary_header{
            height: 250px;
            background: url(https://www.learningberg.com/pluginfile.php/113/course/overviewfiles/AWS-Certified-DevOps-Engineer.jpg);
...
.box-sdw:hover{
    ...
    box-shadow: 2px 4px 8px 0px rgba(46, 61, 73, 0.2);
        ...
        <div class="container py-5">
            <h1 class="display-2 pt-3" style="font-weight: 600;">AWS Certified DevOps Engineer</h1>
            ...
            <div class="container">
                ...
                <div class="row mt-4">
                    ...
                    <div class="col-4">
                            ...
                            <a class="btn btn-cta  theme-btn-secondary" href="/course/view.php?id=4"><div class="text_to_html">Enroll Now</div></a>
                            </div>
                    </div>
                </div>
            </div>
