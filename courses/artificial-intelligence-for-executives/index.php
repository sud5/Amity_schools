...
$PAGE->set_title("Artificial Intelligence for Executives | LearningBerg");
...
echo '
        ...
        .secondary_header{
            height: 250px;
            background: url(https://www.learningberg.com/pluginfile.php/420/course/overviewfiles/Artificial-Intelligence-for-Executives.jpg);
...
.box-sdw:hover{
    box-shadow: 2px 4px 8px 0px rgba(46, 61, 73, 0.2);
        ...
        <div class="container py-5">
            <h1 class="display-2 pt-3" style="font-weight: 600;">Artificial Intelligence for Executives</h1>
            ...
            <div class="container">
                ...
                <div class="row mt-4">
                    ...
                    <div class="col-4">
                            ...
                            <a class="btn btn-cta  theme-btn-secondary" href="/course/view.php?id=14"><div class="text_to_html">Enroll Now</div></a>
                            </div>
                    </div>
                </div>
            </div>
            ...
            <div class="container">
                ...
                <div class="row pt-3">
                    <div class="col-8">
                        ...
                        <h6 class="mt-3 pt-4">Module 1</h6>
