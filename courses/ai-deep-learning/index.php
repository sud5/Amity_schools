...
$PAGE->set_title("AI with deep learning  | LearningBerg");
$PAGE->set_heading("Artificial Intelligence with deep learning"); 
...
echo '
        ...
        .secondary_header{
            height: 250px;
            background: url(https://www.learningberg.com/pluginfile.php/422/course/overviewfiles/AI-with-deep-learning.jpg);
...
.box-sdw:hover{
    box-shadow: 2px 4px 8px 0px rgba(46, 61, 73, 0.2);
        ...
        <div class="container py-5">
            <h1 class="display-2 pt-3" style="font-weight: 600;">AI with deep learning</h1>
            ...
            <div class="container">
                ...
                <div class="row mt-4">
                    ...
                    <div class="col-md-4">
                            ...
                            <a class="btn btn-cta  theme-btn-secondary" href="/course/view.php?id=15"><div class="text_to_html">Enroll Now</div></a>
                            </div>
                    </div>
                </div>
            </div>
