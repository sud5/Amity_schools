...
if ( ! isloggedin() ) { ?>
	...
	<header class="header-bar bg-white shadow-sm">
		<nav class="navbar navbar-expand-lg navbar-light container">
			...
			<ul class="list-unstyled ml-auto d-flex mb-0">
				...
				<li class="nav-item">
					<a class="btn btn-danger px-4" href="login/signup.php">Get Started </a>
				</li>
			</ul>
		...
		<div class="container my-lg-5">
			<div class="row">
				...
				<div class="col-12 col-lg-6">
					...
					<a href=<?php echo $CFG->wwwroot . '/login/signup.php' ?>>
						<button class="btn btn-danger btn-lg">Empower Your Students</button>
					</a>
				</div><!-- End col -->
			</div><!-- End row -->
		</div><!-- End container -->
	...
	<section class="offering-online-courses">
		<div class="container">
			...
			<div class="row ">
				<div class="col-md-4 learning"
				     style="border:1px solid #036;background: linear-gradient(to right,#287a9f,#43a585);padding-bottom: 55px;display: block;border-radius: 50%;">
					<div class="content">
						<h2>K-12</h2>
    ...
    border-radius: 50%;">
				...
				<div class="col-md-4 manage"
				     style="border:1px solid #036;background: linear-gradient(to right,#287a9f,#21A0C1);display: block;padding-bottom: 70px;border-radius: 50%;">
					<div class="content">
						<h2>Corporate Edu</h2>
						<p>Corporate Education refers to a system of professional development activities</p>
					</div>
					<img width="100px" height="100px" src="amigo/assets/images/corporate-education.png"
					     class="img-Logo">
					<div class="cta-wrapper">
	...
	<section class="position-relative bg-light img-style-suffal-- py-3">
		<div class="container">
			<div class="row my-lg-5">
			...
			<div class="row">
				...
				<div class="col-md-3 social-icon">
					...
					<ul>
						...
						<li><a href="https://twitter.com/login"> <i class="fa fa-twitter-square" aria-hidden="true"></i></a>
						</li>
						<li><a href="https://www.linkedin.com/login"><i class="fa fa-Linkedin-square"
						                                                aria-hidden="true"></i></a></li>
						<li><a href="https://www.youtube.com/"><i class="fa fa-Youtube-square"
						                                          aria-hidden="true"></i></a></li>
					</ul>
				</div>
