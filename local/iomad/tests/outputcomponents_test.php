...
class core_outputcomponents_testcase extends advanced_testcase {
	...
	// IOMAD... default theme is Boost but  overrides
	// this to iomadboost
        //$this->assertSame(theme_config::DEFAULT_THEME, $CFG->theme);
        $this->assertSame('iomadboost', $CFG->theme);
	...
	// IOMAD - image is generated differently in iomadboost theme
	...
	// IOMAD
        ...
        $this->assertSame($CFG->wwwroot.'/theme/image.php/iomadboost/core/1/u/f2', $up2->get_url($page, $renderer)->out(false));
        $this->assertEquals($reads, $DB->perf_get_reads());
	...
	// IOMAD
        ...
        $this->assertSame($CFG->wwwroot.'/theme/image.php/iomadboost/core/1/u/f2', $up3->get_url($page, $renderer)->out(false));
        $this->assertEquals($reads, $DB->perf_get_reads());
	...
	// IOMAD
        ...
        $this->assertSame($CFG->httpswwwroot.'/theme/image.php/iomadboost/core/1/u/f2', $up1->get_url($page, $renderer)->out(false));

	$up3 = new user_picture($user3);

	// IOMAD
        //$this->assertSame($CFG->httpswwwroot.'/theme/image.php/boost/core/1/u/f2', $up3->get_url($page, $renderer)->out(false));
        $this->assertSame($CFG->httpswwwroot.'/theme/image.php/iomadboost/core/1/u/f2', $up3->get_url($page, $renderer)->out(false));
