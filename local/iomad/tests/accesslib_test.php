...
class core_accesslib_testcase extends advanced_testcase {
    ...
    public function test_get_all_roles() {
        ...
        $this->assertCount(13, $allroles); // There are 13 roles in a standard  install.
    ...
    public function test_role_get_name() {
        ...
        foreach ($allroles as $role) {
            ...
            //  - only original Moodle roles are localised.
            if ($role->id < 9) {
     ...
     * Ignore  ones that do not specify an archetype
     */
...
//echo "count is $count, totalcount is $totalcount"; die;
        ...
        $this->assertEquals(4 + $numfrontpagemodules, context_inspection::test_context_cache_size()); // Depends on number of default blocks.
