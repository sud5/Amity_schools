...
$string['crontask'] = ' email processing';
...
$string['privacy:metadata:local_email:invoiceid'] = ' eCommerce invoice ID';
...
$string['privacy:metadata:local_email'] = ' email information';
...
$string['course_not_started_warning_name_help'] = 'This email is sent out to a user when they have been given access to a course and have not started it within the defined timeframe in the  course settings.';
