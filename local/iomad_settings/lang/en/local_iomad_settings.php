...
$string['privacy:metadata'] = 'The Local  settings plugin only shows data stored in other locations.';
...
$string['iomadcertificate_logo'] = 'Default logo for  Company certificate';
$string['iomadcertificate_signature'] = 'Default signature for  Company certificate';
$string['iomadcertificate_border'] = 'Default border for  Company certificate';
$string['iomadcertificate_watermark'] = 'Default watermark for  Company certificate';
$string['iomadcertificate_logodesc'] = 'This is the default logo image used for the  Company certificate type. You can override it in the company edit pages. The uploaded image should be 80 pixels high and have a transparent background.';
$string['iomadcertificate_signaturedesc'] = 'This is the default signature image used for the  Company certificate type. You can override it in the company edit pages. The uploaded image should be 31 pixels x 150 pixels and have a transparent background';
$string['iomadcertificate_borderdesc'] = 'This is the default border image used for the  Company certificate type. You can override it in the company edit pages. The uploaded image should be 800 pixels x 604 pixels.';
$string['iomadcertificate_watermarkdesc'] = 'This is the default watermark image used for the  Company certificate type. You can override it in the company edit pages. The uploaded image should be no more than 800 pixels x 604 pixels.';
...
$string['iomad_report_grade_places_help'] = 'This defines the number of decimal places which will be displayed in  reports whenever a users grade is listed';
$string['iomad_settings:addinstance'] = 'Add a new  Settings';
...
$string['iomad_use_email_as_username_help'] = 'Selecting this will change the way a user name is automatically created for a new user account in  so that it simply uses the email address.';
