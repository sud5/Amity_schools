...
$string['report_emails:view'] = 'View the  email report';
$string['report_emails:resend'] = 'Resend  emails';
$string['pluginname'] = 'Outgoing email report';
$string['privacy:metadata'] = 'The Local  email report only shows data stored in other locations.';
