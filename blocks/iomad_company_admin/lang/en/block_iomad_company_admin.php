...
$string['addnewchildcompany'] = 'Add a new child school';
$string['addnewcompany'] = 'Add a new school';
...
$string['applyemailtemplate_help'] = 'Applying this email template will replace the current school email template setting with those from the chosen email template set.';
$string['applyroletemplate'] = 'Apply role template (Previously applied was {$a})';
$string['assigncompetencytemplates'] = 'Assign school learning plan templates';
$string['assigncompetencyframeworks'] = 'Assign school competency frameworks';
...
$string['assigntocompany'] = 'Assign to school';
$string['assigntocompany'] = 'Assign to school';
$string['assignusers'] = 'Assign users';
$string['availabletemplates'] = 'Available role templates';
$string['availabletemplates_help'] = 'These are the list of role templates which are available to school managers when creating a child school';
$string['backtocompanytemplate'] = 'Back to school template';
...
$string['blocktitle'] = 'school / User Admin';
...
$string['companycityfilter'] = 'School location contains';
$string['companygroupsusers'] = 'Manage course groups for ';
$string['company'] = 'School';
...
$string['companycount'] = '{$a} School';
$string['companycountplural'] = '{$a} School';
$string['companycountryfilter'] = 'School country contains';
$string['companycourse'] = 'Course details';
$string['company_course_form_title'] = 'Manage school courses';
$string['companycourses'] = 'School courses';
$string['company_courses'] = 'Courses';
$string['company_courses_for'] = 'School courses for \'{$a}\'';
$string['companycoursesmatching'] = 'School courses matching \'{$a}\'';
$string['company_course_users_title'] = 'Assign users to course';
$string['companycreated'] = 'School created';
$string['companycreatedok'] = 'School was created successfully';
...
$string['companydepartment'] = 'School departments for ';
$string['companydomains'] = 'List of school domains';
$string['companydomains_help'] = 'This is the list of school email domains which will be used to auto assign users to this school through the local  signup plugin.';
$string['company_edit_advanced_title'] = 'Editing User';
$string['company_edit_users_title'] = 'Edit Users';
$string['company_edit_companies_title'] = 'Edit school';
$string['companyfilter'] = 'Filter results';
$string['companyframeworks'] = 'Assign frameworks to school';
$string['company_frameworks_for'] = 'School competency frameworks for \'{$a}\'';
$string['companygroups'] = 'Groups for ';
$string['companyhostname'] = 'Webserver hostname';
$string['companyhostname_help'] = 'If this is defined and the user accesses the site using this hostname they will be redirected to login page branded for this school.';
$string['companyhostnametaken'] = 'Hostname is already used for another school ({$a})';
$string['companymaxusers'] = 'Maximum active users';
$string['companymaxusers_help'] = 'This sets the maximum number of active users allowed for this school.';
$string['companysuspendafter'] = 'Suspend after';
$string['companysuspendafter_help'] = 'If there is a contract end date for the school, the school and all if its users will be suspended after this timeframe.  The school can be unsuspended but the contract end date will need to be updated first to prevent it from being suspended again.';
$string['companyvalidto'] = 'Contract end date';
$string['companyvalidto_help'] = 'This is the date after which all of the school course access and licenses will be removed.  If there is a value for the "Suspend after" field, then the school and all of its users will automatically be suspended from the system too.  All reporting information is still kept.';
$string['compfromraw'] = 'Start date';
$string['comptoraw'] = 'End date';
$string['couldnotdeletecourse'] = 'Course could not be deleted';
$string['couldnotremovecoursefromcompany'] = 'Course could not be removed from the school';
$string['currcompanyframeworks'] = 'Assigned frameworks';
$string['currcompanyframeworksmatching'] = 'Assigned frameworks matching\'{$a}\'';
$string['companylicensecreated'] = 'School license created';
$string['companylicensedeleted'] = 'School license deleted';
$string['companylicenseupdated'] = 'School license updated';
$string['company_license_list_title'] = 'List School Licenses';
$string['company_license_users_title'] = 'Manage user license allocations';
$string['company_list_title'] = 'School Overview';
$string['companylogo'] = 'School Logo';
$string['companymanagement'] = 'School';
$string['company_manager_form_title'] = 'Assign department users/managers';
$string['companymanager'] = 'Admin';
$string['companymanagers'] = 'Admins';
$string['company_managers_for'] = 'Admins for \'{$a}\'';
...
$string['companymanagersmatching'] = 'Admins matching \'{$a}\'';
$string['companyname'] = 'Full Name';
$string['companynamefilter'] = 'School name contains';
$string['companynametaken'] = 'Full name is already used for another school ({$a})';
$string['companyoverview'] = 'School overview';
$string['companyprofilefields'] = ' School Additional Profile Fields';
$string['companyprofileshortname'] = 'URL (must be unique)';
$string['companyreporters'] = 'School reporters';
$string['companysavedok'] = 'School details saved successfully';
$string['companysearchfields'] = 'School search fields';
$string['companyshortname'] = 'URL';
$string['companyshortnametaken'] = 'URL is already used for another school ({$a})';
$string['company_showgrade'] = 'Display course grade on school certificate';
$string['company_showgrade_help'] = 'If you are using the school certificate type then unchecking this will remove any text for the user\'s grade for this school';
$string['companysuspended'] = 'School suspended';
$string['company_templates_for'] = 'School learning plan templates for {$a}';
$string['companyterminated'] = 'School terminated';
$string['companytemplates'] = 'Assign learning plan templates to school';
$string['companyupdated'] = 'School updated';
$string['companyunsuspended'] = 'School un-suspended';
$string['company_uselogo'] = 'Display logo on school certificate';
$string['company_uselogo_help'] = 'If you are using the school certificate type then unchecking this will remove any certificate seal image for this school';
$string['company_usesignature'] = 'Display signature on school certificate';
$string['company_usesignature_help'] = 'If you are using the school certificate type then unchecking this will remove any certificate signature image for this school';
$string['company_useborder'] = 'Display border on school certificate';
$string['company_useborder_help'] = 'If you are using the school certificate type then unchecking this will remove any certificate border image for this school';
$string['company_usewatermark'] = 'Display watermark on school certificate';
$string['company_usewatermark_help'] = 'If you are using the school certificate type then unchecking this will remove any certificate watermark image for this school';
$string['currcompanytemplates'] = 'Assigned templates';
$string['currcompanytemplatesmatching'] = 'Assigned templates matching \'{$a}\'';
$string['currentcompany'] = 'Your school is \'{$a}\'';
$string['companyadvanced'] = 'Advanced School Settings';
$string['company_competency_framework_form_title'] = 'Manage school competency frameworks';
$string['company_competency_template_form_title'] = 'Manage school learning plan templates';
$string['companyuser'] = 'School user ({$a})';
$string['companyuserassigned'] = 'School user assigned';
$string['company_user_form_title'] = 'Assign users to school';
$string['companyusers'] = 'School users';
$string['company_users_course_title'] = 'Manage user enrolments';
$string['company_users_for'] = 'School users for \'{$a}\'';
$string['company_users_for'] = 'Students for \'{$a}\'';
$string['companyusersmatching'] = 'School users matching \'{$a}\'';
$string['company_users'] = 'Users';
$string['companyuserunassigned'] = 'School user unassigned';
...
$string['createcompany'] = 'Create school';
...
$string['createnewcompany'] = 'Create a new school';
$string['createchildcompany'] = 'Create child school';
...
$string['customcss'] = 'Custom school CSS';
$string['dashboard'] = 'Dashboard';
$string['deleteanddestroycoursesfull'] = 'Are you sure you want to delete course {$a}? Clicking continue will remove all current user enrolments, any license allocations and the course from the school. If you click destroy, it will also remove all of the user reords from the all reports. <b>There is no recovery from this without backup</b>';
$string['deletecoursesfull'] = 'Are you sure you want to delete course {$a}? Clicking continue will remove all current user enrolments, any license allocations and the course from the school. <b>There is no recovery from this without backup</b>';
...
$string['deletecompany'] = 'Delete school';
...
$string['deleteroletemplatefull'] = 'Are you sure you want to remove this role template?  This does not remove any restrictions from school, it simply removes this template as an option which can be applied.';
...
$string['deletedepartmentcheckfull'] = 'Are you absolutely sure you want to delete department {$a} and all of it\'s sub-departments?  This will not delete the default school department';
$string['departmentmanager'] = 'HOD';
$string['departmentmanagers'] = 'HODs';
$string['departmentmanagersmatching'] = 'HODs matching \'{$a}\'';
...
$string['designatedcompany'] = 'Designated school';
...
$string['editacompany'] = 'Edit a school';
$string['editcompany'] = 'Edit school';
$string['edit_companies_title'] = 'School settings';
...
$string['educator_help'] = 'Course educators get teacher type roles within school courses.';
...
$string['filtercompany'] = 'Filter school/courses';
$string['firstcompany'] = 'You must create at least one school before you can use ';
...
$string['invaliddepartmentjson'] = 'The file imported does not match the school structure.';
...
$string['iomad_company_admin:addinstance'] = 'Add a new  school admin block';
$string['iomad_company_admin:assign_groups'] = 'Assign users to school groups';
$string['iomad_company_admin:assign_company_manager'] = 'Assign a school manager';
$string['iomad_company_admin:assign_company_reporter'] = 'Assign a school reporter';
...
$string['iomad_company_admin:allcompany_user_profiles'] = 'Manage all user profiles for all school';
...
$string['iomad_company_admin:company_add'] = 'Add a school';
$string['iomad_company_admin:company_add_child'] = 'Add a child school';
$string['iomad_company_admin:company_course'] = 'Add a course to a school';
$string['iomad_company_admin:company_course_unenrol'] = 'Add/remove a course with existing enrolments';
$string['iomad_company_admin:company_course_users'] = 'Enrol/unenrol users on school courses';
$string['iomad_company_admin:company_delete'] = 'Delete a school';
$string['iomad_company_admin:company_edit'] = 'Edit a school';
$string['iomad_company_admin:company_edit_appearance'] = 'Edit the school appearance';
$string['iomad_company_admin:company_edit_certificateinfo'] = 'Edit the school certificate options';
$string['iomad_company_admin:company_framework'] = 'Assign competency frameworks to a school';
$string['iomad_company_admin:company_manager'] = 'Admin form';
$string['iomad_company_admin:companymanagement_view'] = 'View school management tab';
$string['iomad_company_admin:company_template'] = 'Assign learning plan templates to a school';
$string['iomad_company_admin:company_user'] = 'School user form';
$string['iomad_company_admin:company_user_profiles'] = 'Manage all user profiles for school';
$string['iomad_company_admin:company_view_all'] = 'View all school';
$string['iomad_company_admin:company_view'] = 'View list of school';
...
$string['iomad_company_admin:edit_all_departments'] = 'Edit all school departments';
$string['iomad_company_admin:editallusers'] = 'Edit users in every school';
$string['iomad_company_admin:edit_departments'] = 'Edit own school departments';
$string['iomad_company_admin:edit_groups'] = 'Edit school course groups';
$string['iomad_company_admin:edit_licenses'] = 'Edit school licenses';
$string['iomad_company_admin:edit_my_licenses'] = 'Edit my school licenses';
$string['iomad_company_admin:editmanagers'] = 'Edit school managers in own school';
$string['iomad_company_admin:editusers'] = 'Edit users in own school';
$string['iomad_company_admin:edituserpassword'] = 'Resend password details to users in own school';
$string['iomad_company_admin:export_departments'] = 'Export school departments to a file';
$string['iomad_company_admin:deleteuser'] = 'Delete users in own school';
$string['iomad_company_admin:suspenduser'] = 'Suspend users in own school';
$string['iomad_company_admin:company_license_users'] = 'Modify user license allocations';
$string['iomad_company_admin:import_departments'] = 'Import school departments from a file';
...
$string['iomad_company_admin:deletecourses'] = 'Delete a non-shared school course';
$string['iomad_company_admin:destroycourses'] = 'Delete a non-shared school course and remove all held user data for it.';
$string['iomad_company_admin:managecourses'] = 'Mage  course settings';
$string['iomad_company_admin:viewcourses'] = 'View school courses';
...
$string['iomad_company_admin:myaddinstance'] = 'Add a new  school admin block to the users dashboard';
$string['iomad_company_admin:restrict_capabilities'] = 'Restrict role capabilties for school';
$string['iomad_company_admin:split_my_licenses'] = 'Split a license to a child school';
$string['iomad_company_admin:suspendcompanies'] = 'Suspend a school';
$string['iomad_company_admin:templateview'] = 'View templates from dashboard';
$string['iomad_company_admin:unallocate_licenses'] = 'Unallocate licenses from school';
...
$string['iomad_company_admin:view_licenses'] = 'View school licenses';
$string['iomad_company_admin:view_my_company_email'] = 'Unused ';
$string['iomad_company_admin:view'] = 'View a school';
$string['isdefaultgroupdelete'] = 'This is the default school course group.  You can edit it but not delete it.';
...
$string['fullnamedepartment'] = 'Full name of the department';
...
$string['hide_suspended_companies'] = 'Hide suspended school?';
$string['invalid_company'] = 'Optional field profile_field_school must match your school\'s shortname.';
$string['inuse'] = 'In use';
...
$string['managecompanies'] = 'Manage School';
$string['managecompany'] = 'Manage School';
$string['managecourses'] = 'Select';
$string['managegroups'] = 'Manage school groups';
$string['managelicenses'] = 'License management';
$string['managemanagers'] = 'Select';
$string['managementtitle'] = 'School, User and Course Management';
$string['manager'] = 'Manager';
$string['manageremails'] = 'Manager emails';
$string['managernotify'] = 'Send manager emails';
$string['managernotify_help'] = 'Choose what type of notifications a school manager will get for their users.  Whether it is reminder emails to complete a course or course completion information for users or both.';
...
$string['maxuserswarningplural'] = 'Adding these users will increase the total number of active users in school beyond the maximum allowed ({$a}). You will need to either suspend or delete some current users or contact the site administrator to increase the allowed value.';
$string['missingcompany'] = 'Missing school';
...
$string['nocompanies'] = 'There are no school - please add a school first';
$string['nocompaniesfilter'] = 'No school match your current filter';
$string['nocompaniesfound'] = 'There are no school which match your criteria';
$string['nocompany'] = 'Unallocated courses';
$string['nocompanyframeworks'] = 'Unallocated competency frameworks';
$string['nocompanyselected'] = 'No school is selected. Please make a selection above';
...
$string['noneselected'] = 'No school selected';
...
$string['iomadreports'] = 'School reports';
$string['parentcompany'] = 'Parent school';
$string['parentcompany_help'] = 'Select the parent school for this school.  Admins in the parent school will automatically be assigned as school managers in this school and licenses can be split from a parent school to a child school.';
$string['parentcompanysuspended'] = 'School cannot be un-suspended without it\'s parent school';
...
$string['pleaseselect'] = 'Please select a school from the dropdown box on the Dashboard page';
$string['pluginname'] = ' School / User Admin';
...
$string['potmanagersmatching'] = 'Potential users matching \'{$a}\'';
$string['potmanagers'] = 'Potential users';
...
$string['privacy:metadata'] = 'The  School admin block only shows data stored in other locations.';
$string['profile_field_company_not_empty_does_not_match_selected'] = 'profile_field_school is not empty and does not match the selected school.';
$string['profile_field_company_not_set'] = 'profile_field_school is required when no school has been selected.';
...
$string['roletemplate_help'] = 'Select the role template to be applied to this school.  Child school can inherit as well as use a template which is allocated to the school.  This will change all of the school and department managers capabilities for this school';
$string['roletemplatename'] = 'Role template name';
$string['roletemplatename_help'] = 'This is the name which the template will be saved as.  You can select this when creating school';
...
$string['saveasnewcompany'] = 'Save new school';
...
$string['shared_help'] = '<ul><li><b>No</b> - Course is not shared</li><li><b>Open sharing</b> - Course is shared across <b>all</b> school</li><li><b>Closed sharing</b> - Course is shared between selected school (see <i>Course management > Assign to school</i>)</li></ul>';
$string['shared_framework_help'] = '<ul><li><b>No</b> - Framework is not shared</li><li><b>Open sharing</b> - Framework is shared across <b>all</b> school</li><li><b>Closed sharing</b> - Framework is shared between selected school (see <i>Competency management > Assign framework to school</i>)</li></ul>';
$string['shared_template'] = 'sharing competency template settings';
$string['shared_framework'] = 'sharing competency framework settings';
$string['shared_template_help'] = '<ul><li><b>No</b> - Template is not shared</li><li><b>Open sharing</b> - Template is shared across <b>all</b> school</li><li><b>Closed sharing</b> - Template is shared between selected school (see <i>Competency management > Assign template to school</i>)</li></ul>';
...
$string['showallcompanies'] = 'Show all school';
$string['show_all_company_users'] = 'Show users from every school?';
$string['showhistoricusers'] = 'Show historic results';
$string['showothermanagers'] = 'Show external school managers';
$string['showothermanagers_help'] = 'Select this if you would like to show school managers from other school.  This is only available if the role type you are assigning is the school manager one.';
$string['show_suspended_companies'] = 'Show suspended school?';
$string['split'] = 'Split';
...
$string['suspendcompany'] = 'Suspend school';
$string['suspendcompanycheck'] = 'Do you really want to suspend this school?';
$string['suspendcompanycheckfull'] = 'Do you really want to suspend this school?  This will suspend all of the users who are associate to this school but will keep the courses and other school details intact.';
...
$string['unsuspendcompany'] = 'Unsuspend school';
$string['unsuspendcompanycheck'] = 'Do you really want to unsuspend this school?';
$string['unsuspendcompanycheckfull'] = 'Do you really want to unsuspend this school?  This will unsuspend all of the users who are associate to this school.';
...
$string['upload_no_company_no_courses'] = 'Courses can only be selected when a school is selected.';
$string['upload_no_company_selected'] = 'No school selected, profile_field_school must be present in the uploaded file.';
...
$string['archetypecompanymanager_role'] = 'Admin';
$string['companymanager_role'] = 'Admin';
$string['archetypecompanydepartmentmanager_role'] = 'School department manager';
$string['companydepartmentmanager_role'] = 'School department manager';
$string['archetypecompanycourseeditor_role'] = 'School course editing teacher';
$string['companycourseeditor_role'] = 'School course editing teacher';
$string['archetypecompanycoursenoneditor_role'] = 'School course non editing teacher';
$string['companycoursenoneditor_role'] = 'School course non editing teacher';
$string['archetypeclientreporter_role'] = 'School report only';
