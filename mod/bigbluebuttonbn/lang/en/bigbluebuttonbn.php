...
$string['activityoverview'] = 'You have upcoming virtual class sessions';
...
$string['bigbluebuttonbn:addinstance'] = 'Add a new virtual class room/activity';
$string['bigbluebuttonbn:join'] = 'Join a virtual class meeting';
$string['bigbluebuttonbn:view'] = 'View a room/activity';
$string['bigbluebuttonbn:managerecordings'] = 'Manage virtual class recordings';
...
$string['bigbluebuttonbn'] = 'Virtual Class';
$string['indicator:cognitivedepth'] = 'Virtual Class cognitive';
$string['indicator:cognitivedepth_help'] = 'This indicator is based on the cognitive depth reached by the student in a Virtual Class activity.';
$string['indicator:socialbreadth'] = 'Virtual Class social';
$string['indicator:socialbreadth_help'] = 'This indicator is based on the social breadth reached by the student in a Virtual Class activity.';
$string['modulename'] = 'Virtual Class';
$string['modulenameplural'] = 'Virtual Class';
$string['modulename_help'] = 'Virtual Class lets you create from within Moodle links to real-time on-line classrooms using Virtual Class, an open source web conferencing system for distance education.
...
$string['modulename_link'] = 'Virtual Class/view';
$string['pluginadministration'] = 'Virtual Class administration';
$string['pluginname'] = 'Virtual Class';
...
$string['search:activity'] = 'Virtual Class - activity information';
$string['search:tags'] = 'Virtual Class - tags information';

$string['privacy:metadata:bigbluebuttonbn'] = 'Stores the configuration for the room or activity that defines the features and general behaviour of the Virtual Class session.';
...
$string['privacy:metadata:bigbluebutton'] = 'In order to create and join Virtual Class sessions, user data needs to be exchanged with the server.';
$string['privacy:metadata:bigbluebutton:userid'] = 'The userid of the user accessing the Virtual Class server.';
$string['privacy:metadata:bigbluebutton:fullname'] = 'The fullname of the user accessing the Virtual Class server.';

$string['config_general'] = 'General configuration';
$string['config_general_description'] = 'These settings are <b>always</b> used';
$string['config_server_url'] = 'Virtual Class Server URL';
$string['config_server_url_description'] = 'The URL of your Virtual Class server must end with /bigbluebutton/. (This default URL is for a Virtual Class server provided by Blindside Networks that you can use for testing.)';
$string['config_shared_secret'] = 'Virtual Class Shared Secret';
$string['config_shared_secret_description'] = 'The security salt of your Virtual Class server.  (This default salt is for a Virtual Class server provided by Blindside Networks that you can use for testing.)';
...
$string['config_recording_default_description'] = 'If enabled the sessions created in Virtual Class will have recording capabilities.';
...
$string['config_waitformoderator_cache_ttl_description'] = 'To support a heavy load of clients this plugin makes use of a cache. This parameter defines the time the cache will be kept before the next request is sent to the Virtual Class server.';
...
$string['config_preuploadpresentation_description'] = 'These settings enable or disable options in the UI and also define default values for these options. The feature works only if the Moodle server is accessible to Virtual Class..';
...
$string['config_extended_capabilities_description'] = 'Configuration for extended capabilities when the Virtual Class server offers them.';
$string['config_uidelegation_enabled'] = 'UI delegation is enabled';
$string['config_uidelegation_enabled_description'] = 'These settings enable or disable the UI delegation to the Virtual Class server.';
...
$string['config_warning_bigbluebuttonbn_cfg_deprecated'] = 'Virtual Class is making use of config.php with a global variable that has been deprecated. Please convert the file as it will not be supported in future versions';
...
$string['general_error_unable_connect'] = 'Unable to connect. Please check the url of the Virtual Class server AND check to see if the Virtual Class server is running.';
...
$string['index_error_unable_display'] = 'Unable to display the meetings. Please check the url of the Virtual Class server AND check to see if the Virtual Class server is running.';
...
$string['index_heading'] = 'Virtual Class Rooms';
...
$string['mod_form_field_welcome_help'] = 'Replaces the default message setted up for the Virtual Class server. The message can includes keywords  (%%CONFNAME%%, %%DIALNUM%%, %%CONFNUM%%) which will be substituted automatically, and also html tags like <b>...</b> or <i></i> ';
$string['mod_form_field_welcome_default'] = '<br>Welcome to <b>%%CONFNAME%%</b>!<br><br>For help on using Virtual Class see these (short)  <a href="event:http://www.bigbluebutton.org/content/videos"><u>tutorial videos</u></a>.<br><br>To join the audio bridge click the phone icon (top center). <b>Please use a headset to avoid causing background noise for others.</b>';
...
$string['mod_form_field_instanceprofiles_help'] = 'Select the type for this Virtual Class instance.';
...
$string['view_error_unable_join_student'] = 'Unable to connect to the Virtual Class server. Please contact your Teacher or the Administrator.';
$string['view_error_unable_join_teacher'] = 'Unable to connect to the Virtual Class server. Please contact the Administrator.';
$string['view_error_unable_join'] = 'Unable to join the meeting. Please check the url of the Virtual Class server AND check to see if the Virtual Class server is running.';
$string['view_error_bigbluebutton'] = 'Virtual Class responded with errors. {$a}';
$string['view_error_create'] = 'The Virtual Class server responded with an error message, the meeting could not be created.';
...
$string['view_noguests'] = 'The Virtual Class is not open to guests';
...
$string['view_message_recordings_disabled'] = 'Recordings were disabled on this server. Virtual Class instances for recordings only can not be used.';
...
$string['view_recording_publish_link_deleted'] = 'This link can not be re-published because the actual recording does not exist in the current Virtual Class server. The link should be removed.';
...
$string['view_recording_unprotect_link_deleted'] = 'This link can not be un-protected because the actual recording does not exist in the current Virtual Class server. The link should be removed.';
...
$string['view_error_current_state_not_found'] = 'Current state was not found. The recording may have been deleted or the Virtual Class server is not compatible with the action performed.';
$string['view_error_action_not_completed'] = 'Action could not be completed';
$string['view_warning_default_server'] = 'This Moodle server is making use of the Virtual Class testing server that comes pre-configured by default. It should be replaced for production.';
...
$string['index_error_noinstances'] = 'There are no instances of Virtual Class';
$string['index_error_bbtn'] = 'Virtual Class ID {$a} is incorrect';
